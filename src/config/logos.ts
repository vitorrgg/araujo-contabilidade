...
export const logoFiles: ArquivoLogo[] = [
  ...
  {
    nome: 'gccont-monograma-dourado-fundo-marinho',
    rotulo: 'Monograma dourado sobre marinho',
    uso: 'Selo quadrado sem o fio: avatar, favicon e carimbo digital.',
    composicao: 'monograma',
    variante: 'cor',
    fundo: 'marinho',
    preview: 'claro',
  ...
  {
    nome: 'gccont-monograma-branco-fundo-marinho',
    rotulo: 'Monograma branco sobre marinho',
    uso: 'A mesma peça em uma cor só, para impressão restrita.',
    composicao: 'monograma',
    variante: 'mono-branca',
    fundo: 'marinho',
    preview: 'claro',
  ...
  {
    nome: 'gccont-monograma-marinho-fundo-branco',
    rotulo: 'Monograma marinho sobre branco',
    uso: 'Para quando o selo precisa cair sobre fundo escuro ou foto.',
    composicao: 'monograma',
    variante: 'mono-escura',
    fundo: 'branco',
    preview: 'escuro',
